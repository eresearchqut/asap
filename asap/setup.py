...
setup(name='eresearchqut-asap',
      version="1.0.0",
      packages=packages,
      description='TRRF e-Consent for ASAP',
      long_description='e-Consent for ASAP is a patient registry based on TRRF (https://github.com/eresearchqut/trrf).',
